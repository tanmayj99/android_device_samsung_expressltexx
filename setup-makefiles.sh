...
LINEEND=" \\"
COUNT=`wc -l ../expressltexx/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../expressltexx/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
FIRST=1
...
LINEEND=" \\"
COUNT=`wc -l ../expressltexx/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../expressltexx/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
